  ...
  module Cassandra
    ...
    describe Truncation do
      ...
      before(:all) do
        ...
        ::ActiveColumn.connection = ::Cassandra.new(@test_db, '127.0.0.1:9160')
        ::ActiveColumn.keyspace_tasks.create(@test_keyspace_db)
      end

      before(:each) do
        ::ActiveColumn.keyspace_tasks.drop(@test_keyspace_db)
      end
